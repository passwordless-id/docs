...
<iframe src="https://ui.passwordless.id"></iframe>

---

<MyCard icon="/img/features/Safety-Box.svg">
...
<MyCard icon="/img/features/Protection.svg">
...
<MyCard icon="/img/features/Lock-Pattern.svg">
...
<MyCard icon="/img/features/Phishing-Attack.svg">
...
<MyCard icon="/img/features/icon-device.svg">
...
<MyCard icon="/img/features/innovation.svg">
...
<MyCard icon="/img/features/coder-woman.svg">
...
<MyCard icon="/img/features/API-Integration.svg">
...
<MyCard icon="/img/features/life-buoy.svg">
...
<MyCard icon="/img/features/icon-target.svg">
...
<MyCard icon="/img/features/customer-experience.svg">
