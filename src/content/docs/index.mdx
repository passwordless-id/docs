...
hero:
    ...
    #image:
    #    file: ../../assets/banner-biometric-auth.svg
    #    alt: "Passwordless.ID Banner"
    actions:
        - text: Try it out
...
![passwordless-id-banner](../../assets/banner-biometric-auth.svg)

> Ditch passwords, *boost security!*  
> With our public *authentication platform.*

# This is work-in-progress as preparation of porting the Passwordless.ID "v1" to "v2"

---

![passwordless-id-banner](../../assets/logo/logo-text.svg)

Passwordless.ID is a public identity provider that can be used out-of-the-box, compatible with *OAuth2* and *OpenID*. 

![passwordless-openid-diagram](../../assets/passwordless-openid-diagram.png)
...
- https://passwordless.id/ssa/sign-in
- https://passwordless.id/ssa/profile
- https://passwordless.id/ssa/sign-out
